;;; light-baby-doom.el --- inspired by babys creampied pusy-*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(def-doom-theme light-baby-doom
...
((bg             '("#fff8e7" nil         nil           ))
 ...
 (fg             '("#252928" "#bfbfbf"   "brightwhite" ))

 (grey           '("#656565" "#515154"   "brightblack"  ))
 (red            '("#CE5D57" "#CC6666"   "red"          ))
 (orange         '("#CA8D50" "#E6C000"   "brightred"    ))
 (green          '("#7C945C" "#C2FFDF"   "green"        ))
 ...
 (auburn         '("#502F2A" "#502F2A"   "red"          ))
 (garish         '("#4A5F54" "#4A5F54"   "yellow"       ))
